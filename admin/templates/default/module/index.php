<div class="wrap">
    ...
    <form id="sed-search-modules" name="sed-search-modules" action="<?php echo admin_url("admin.php");?>" method="get">
        <?php
    ...
    <form id="sed-bulk-action-form" name="sed-bulk-action-form" action="<?php echo admin_url("admin.php?page=site_editor_module");?>" method="post">
