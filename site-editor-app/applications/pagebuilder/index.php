...
if(!defined('SED_APP_PATH')){
    ...
    define('SED_ADMIN_PATH',                SED_BASE_DIR . DS . 'admin');
    define('SED_APP_PATH',                  SED_BASE_DIR . DS . 'application');
    define('SED_APPS_PATH',                 SED_BASE_DIR . DS . 'applications');
    define('SED_CTRL_PATH',                 SED_BASE_DIR . DS . 'controller');
    define('SED_EXT_PATH',                  SED_BASE_DIR . DS . 'extensions');
    define('SED_INC_PATH',                  SED_BASE_DIR . DS . 'includes');
    define('SED_LIB_PATH',                  SED_BASE_DIR . DS . 'libraries');
    define('SED_MODEL_PATH',                SED_BASE_DIR . DS . 'model');
    define('SED_TMPL_PATH',                 SED_BASE_DIR . DS . 'templates');
    define('SED_DEV_PATH',                  SED_BASE_DIR . DS . 'developer');
    define('SED_IMG_PATH',                  SED_BASE_DIR . DS . 'images');
