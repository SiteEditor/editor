...
class PBShortcodeClass{
    ...
    function __construct(  $args = array() ) {
        ...
        add_action( 'sed_page_builder', array( $this , 'register_module_shortcode' ), 10 , 1  );
        //add_action( 'sed_ajax_pb', array( $this , 'ajax_register_shortcode' ), 10 , 1  );
        add_action( 'sed_page_builder', array( $this , 'add_contextmenu' ) , 10 , 1 );
    ...
    function register_module_shortcode($pagebuilder) {
        global $sed_pb_app;
    ...
    function create_settings(){
        ...
        $params = $this->shortcode_settings();
    ...
    */
    ...
    function set_media( $attachment ){
        global $sed_apps;
        array_push( $sed_apps->attachments_loaded , $attachment );
