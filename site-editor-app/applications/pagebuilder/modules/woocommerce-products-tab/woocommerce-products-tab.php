...
class PBWoocommerceProductsTabShortcode extends PBShortcodeClass{
    ...
    function ajax_tab_loader(){
        ...
        global $sed_apps;
        //$sed_apps->check_ajax_handler('product_in_tab_loader' , 'sed_app_products_tab');
    ...
    function product_sub_categories(){
    	//check if referer is ok
        global $sed_apps;
        $sed_apps->check_ajax_handler('product_categories_loader' , 'sed_app_product_categories');
    ...
    function print_options(){
        global $site_editor_app;
        $ajax_options = array(
            "ajax_url"  => SED_BASE_URL . "libraries/ajax/site_editor_ajax.php"  ,
