...
<form id="order_review" method="post">
	...
	<div id="payment" class="checkout-box">
		...
		<div class="form-row">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="btn btn-main alt" id="place_order" value="' . esc_attr( $pay_order_button_text ) . '" data-value="' . esc_attr( $pay_order_button_text ) . '" />' );
			?>			
