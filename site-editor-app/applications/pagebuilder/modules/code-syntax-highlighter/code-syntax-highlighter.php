...
$sed_pb_app->register_module(array(
    ...
    //"transport"   => "ajax" ,
    "tpl_type"    => "underscore" ,
    "js_module"   => array( 'sed-code-syntax-highlighter-module', 'code-syntax-highlighter/js/sed-code-syntax-highlighter-module.min.js', array('site-iframe' , 'jquery-contenteditable') )
