...
?>
<div <?php echo $sed_attrs; ?>  data-contextmenu-post-id="<?php echo get_the_ID();?>" data-sed-post-role="post-module-container" class="module single-posts single-posts-skin2 <?php echo $classes; ?> <?php echo $class;?>" >
<?php
  // Start the Loop.
