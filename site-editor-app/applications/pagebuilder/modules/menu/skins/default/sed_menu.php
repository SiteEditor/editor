...
<div <?php echo $sed_attrs; ?> class="<?php echo $class.' '.$sticky_styles ?> <?php echo ( $orientation == 'vertical'  ? 'vertical-megamenu' : '' )  ?> navbar-wrap module module-megamenu megamenu-defult " >
    <div class="container-megamenu <?php echo $length_class;?> <?php if( $enable_draggable_area ) echo "menu-has-draggable-area";?>" length_element >
        ...
        <div class="navbar-container">
            <div class="navbar-header">
                <div class="navbar-header-inner <?php if(sed_is_mobile_version()) echo 'hide';?>">
            ...
            <nav class="navbar navbar-inverse megamenu" role="navigation" >
                <div id="<?php echo $module_html_id; ?>-navbar-toggle" class="navbar-collapse collapse in">
    			<?php
