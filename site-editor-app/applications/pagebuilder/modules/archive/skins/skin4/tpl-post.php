...
<article class="entry-item clearfix post item <?php echo $column_class?>">
    <div class="inner archive-item-body <?php if( $sed_data['archive_border_width'] == 0) echo 'content-without-border'; ?>">
<?php
...
?>
         <div class="entry-thumb image <?php if( !$sed_data['archive_thumbnail'] ) echo 'hide'; ?>">
    ...
    ?>
        ...
        <div class="entry-content <?php if( is_null( $thumb_info ) || !$sed_data['archive_thumbnail'] ) echo 'content-full-width'; ?>" >
            <header>
                <h4 class="entry-title title">
                    <a href="<?php the_permalink()?>"><?php the_title()?></a>
                </h4>
            </header>
            <div class="meta-container meta-info <?php if( !$sed_data['archive_post_meta_show'] ) echo 'hide'; ?>">
                <span class="entry-date item-meta post-date <?php if( !$sed_data['archive_date_show'] ) echo 'hide'; ?>"><i class="icon-meta fa fa-calendar-o"></i><span class="label-meta"><?php echo the_time($data_format) ?></span></span>
                <span class="entry-meta">&nbsp;&nbsp;</span>
                <span class="entry-author item-meta post-author <?php if( !$sed_data['archive_author_show'] ) echo 'hide'; ?>">
                ...
                <span class="entry-meta">&nbsp;&nbsp;</span>
                <span class="entry-comments item-meta post-comments <?php if( !$sed_data['archive_comment_count_show'] ) echo 'hide'; ?>">
            ...
            <div class="post_content content <?php if( !$sed_data['archive_excerpt_content_show'] ) echo 'hide'; ?>">
            ...
            <div class="entry-cats item-meta post-cat <?php if( !$sed_data['archive_cat_show'] ) echo 'hide'; ?>" >
                <i class="icon-meta fa fa-folder"></i>
                 <span class="label-meta"><?php _e("Categories: ","site-editor")?></span>
                 <?php the_category( ' ' ); ?>
            </div>
            <div class="entry-tags item-meta post-tags <?php if( !$sed_data['archive_tags_show'] ) echo 'hide'; ?>">
