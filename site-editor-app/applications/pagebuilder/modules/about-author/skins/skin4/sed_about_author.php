...
?>
<div <?php echo $sed_attrs; ?> data-sed-post-role="about-author-module"  class="module item-posts-module  about-author about-author-skin4 <?php echo $class;?> <?php if(!$sed_data['single_post_show_author_info_box'] || post_password_required() ) echo "hide";?>">
