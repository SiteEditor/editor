...
?>
<div <?php echo $sed_attrs; ?> data-sed-post-role="about-author-module"  class="module item-posts-module about-author about-author-default <?php echo $class;?> <?php if(!$sed_data['single_post_show_author_info_box'] || post_password_required() ) echo "hide";?>">
   ...
   <div class="media bio-author-box">
    ...
    <!--    <a class="author-link botton botton-sm botton-default " href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
