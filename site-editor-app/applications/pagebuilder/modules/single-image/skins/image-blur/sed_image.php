...
<div <?php echo $sed_attrs; ?> class="ih-item square module module-image skin-image-blur <?php echo $effect_class;?> <?php echo  $class;?>"  >

  <?php if(empty($hover_effect) || ( !empty($hover_effect) && $effect_type == 'img-reset-blur')){
    ...
    <a class="img" href="<?php echo $full_src;?>" data-lightbox="<?php if(!empty($lightbox_id)) echo $lightbox_id;else echo $id;?>" data-title="<?php echo $title;?>">
       <img class="sed-img blur"  src="<?php echo $src;?>" alt="<?php echo $alt;?>">
    </a>
    <?php } ?>
  ...
  <?php if(!empty($hover_effect) && $effect_type != 'img-reset-blur'){  ?>
    <div class="img">
      <img class="sed-img blur"  src="<?php echo $src;?>" alt="<?php echo $alt;?>">
    </div>
    <div class="info">
