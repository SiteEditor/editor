...
<div <?php echo $sed_attrs; ?> class="module module-blog module-blog-skin5 sed-columns-<?php echo $number_columns;?> <?php echo $class; ?> ">
...
[sed_model_id="<?php echo $sed_model_id; ?>"] .items-container{
  margin: -<?php echo $masonry_spacing;?>px;
}
</style>