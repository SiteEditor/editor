<div class="add-new-layout">
    <a href="javascript:void(0)" class="btn btn-default3 sed_ajax_load_options_btn" data-dialog-id="sed-dialog-add-layout" data-setting-id="sed_add_layout"  title="<?php echo __("add New Layout","site-editor");  ?>" id="sed_add_page_layout" role="button" >
