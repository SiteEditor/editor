...
siteEditor.PluginManager.add('appLayout', function(siteEditor) {
    ...
    api.LayoutsManagerControl = api.Control.extend({
        ...
        removeLayout : function ( slug , confirm ) {
            ...
            if( slug == "default" ){
                ...
                var pageLayouts = $.extend( true, {} , api('sed_pages_layouts')() );
                _.each( pageLayouts , function( layout , pagesGroup ){
                    if( layout == slug ){
                        pageLayouts[pagesGroup] = "default";
                    }
                });
                api('sed_pages_layouts').set( pageLayouts );
   ...
   $( function() {
        ...
        $(".sed_all_layouts_options_select").livequery(function(){
        ...
        $(".sed_ajax_load_options_btn").click(function(){
            var $this = $(this);
            $("#" + $(this).data("dialogId")).dialog("open");
                ...
                success : function(){
                    ...
                    if( !_.isEmpty( controls ) ){
                        _.each( controls , function( data , id ){
                            ...
                            if( $this.data("settingId") == "sed_pages_layouts" ) {
                                var control = api.control.instance(id);
                                control.update( data.default_value );
                            }
