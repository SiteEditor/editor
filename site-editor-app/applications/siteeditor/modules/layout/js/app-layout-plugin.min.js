...
siteEditor.PluginManager.add('appLayout', function(siteEditor) {
   ...
   $( function() {
        ...
        $(".sed_ajax_load_options_btn").click(function(){
            ...
            var optionsAjaxloader = new api.Ajax({
                ...
                success : function(){
                    ...
                    $("#" + $this.data("dialogId")).html( template );
                },
                error : function(){
       ...
       app.controller("myCtrl", function($scope) {
           ...
           $scope.myText = $scope.products.join(",");
           $scope.editMode = "hide";
           ...
           $scope.saveItem= function () {
               ...
               $scope.products[$scope.editIndex] = $scope.editMe;
               $scope.editMode = "hide";
           }
       ...
       /*
        http://www.w3schools.com/angular/tryit.asp?filename=try_ng_app4
