    ...
    */
    ...
    api.AppSettings = api.Class.extend({
        ...
        view : function(){
            ...
            $(".sed-tab-scope-options .tab-scope-item").livequery(function(){
                $(this).click(function(){
                    ...
                    $(this).parents(".row_settings:first").siblings().hide();

                    var currScope = $(this).parents(".row_settings:first").siblings().find(".sed-option-scope." + type );
                    currScope.parents(".row_settings:first").show();
        ...
        ajaxLoadSettings : function( ){
            ...
            var optionsAjaxloader = new api.Ajax({
                ...
                success : function(){
                    ...
                    api.Events.trigger( "afterInitAppendModulesSettingsTmpl" , self , $currentElDialog );
