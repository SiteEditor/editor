        ...
        api.LayoutScopeControl = api.Control.extend({
    		...
    		ready: function() {
                ...
                this.confirmEventIds = {
                    ...
                    "hiddenToPublic"    : "changeScopeHiddenToPublicConfirm" ,
                };
                ...
                api.previewer.bind( "ok_" + this.confirmEventIds.hiddenToPublic , function(){
            ...
            updateLayoutsContent : function(){
                ...
                control.layoutsContent = api('sed_layouts_content')();
                ...
                _.each( api.pagesThemeContent[api.settings.page.id] , function( shortcode , index ){
                    ...
                    if( !_.isUndefined( shortcode.theme_id ) && _.isUndefined( shortcode.is_customize ) ){
                        ...
                        control.layoutsContent[shortcode.theme_id] = rowShortcodes;

                    }

                });

                api( 'sed_layouts_content' ).set( control.layoutsContent );
            },
            ...
            createThemeContent : function(){
                ...
                /*_.map( control.layoutsContent , function( shortcodes , theme_id ){
                    var newIds = _.pluck( shortcodes , 'id' );
                    if( !$.isArray( newIds ) ){
                        newIds = [];
                    }
                ...
                _.each( api.pagesThemeContent[api.settings.page.id] , function( shortcode , index ){
                    ...
                    if( !_.isUndefined( shortcode.theme_id ) && _.isUndefined( shortcode.is_customize ) ){
                        ...
                        var newIndex = control.getShortcodeIndex(shortcode.id , api.pagesThemeContent[api.settings.page.id] );

                        control.deleteModule( shortcode.id , tChildren , api.pagesThemeContent[api.settings.page.id] , newIndex );
