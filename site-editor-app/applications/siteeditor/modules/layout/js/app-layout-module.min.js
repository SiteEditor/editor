(function( exports, $ ) {
    ...
    api.AppLayouts = api.Class.extend({
            ...
            api.preview.bind( "sedLayoutChangeScope" , function( obj ){
                ...
                switch( type ){
                    ...
                    case "customizeToHidden" :
                        self.customizeToHidden( rowElement , themeId , elementId , bj.usingDataMode );
                    break;
                    case "publicToHidden" :
        ...
        sortThemeRow : function(){
            ...
            api.addFilter('modulesSortableFilters', function ( result , item , sortAreaStart ) {

                if( !_.isUndefined( self.sortThemeId ) && !_.isUndefined( self.sortRowEl ) ) {
                    api.preview.send( "sedDestroyThemeRowWithSort" );

                    api.pageBuilder.addRemoveSortableClass( item.parents(".bp-component:first") , 1 );
            ...
            api.Events.bind( "moduleBeforeSortableStopEvent" , function( ui ){
                var item = ui.item ;
                if( item.parent().hasClass("site-main") )
                    stopInRoot = true;
                else
