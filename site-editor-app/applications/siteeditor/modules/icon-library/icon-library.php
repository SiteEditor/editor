...
if(!class_exists('SiteEditorIconManager'))
{
	class SiteEditorIconManager
	{
		...
		{
            $this->module_base_dir = SED_APPS_PATH. DS . "siteeditor" . DS . "modules" . DS . "icon-library";
            ...
            add_action( 'sed_init' , array($this,'load_styles') );
            ...
            add_filter('sed_custom_js_plugins', array($this,'add_icons_library_js_plugin') );
        ...
        function js_I18n( $I18n ){
            ...
            $I18n['remove_font_error']       =  __("Couldn't remove the font.<br/>The script returned the following error:" , "site-editor");
            return $I18n;
        }
        ...
        public function load_styles(){
			...
			if(is_array($this->fonts))
			{
				...
				{
                    $site_editor_style->add( 'sed-'.$font, $info['style'] , array());
                    $site_editor_style->load_styles(array( 'sed-'.$font ));
				}
			}
        }

        public function add_icons_library_js_plugin($plugin_array) {
           $plugin_array['iconsLibrary'] = SED_BASE_URL . 'applications/siteeditor/modules/icon-library/js/iconsLibraryPlugin.min.js';
           return $plugin_array;
        }
        ...
        public function add_zipped_font(){
            ...
            global $sed_apps;
            $sed_apps->check_ajax_handler('icon_font_loader' , 'sed_app_icon_font_load');
    	...
    	*/
		...
		{
		    global $sed_apps;
            $sed_apps->check_ajax_handler('icon_font_remove' , 'sed_app_icon_font_remove');
			//get the file path of the zip file
