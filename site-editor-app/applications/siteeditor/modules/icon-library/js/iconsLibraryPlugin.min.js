...
siteEditor.PluginManager.add('iconsLibrary', function(siteEditor) {
              ...
              var __addZippedFont = function( filedata ){
                  ...
                  $.ajax({
                      ...
                      data:
                      {
                          ...
                          filedata      : filedata,
                          nonce         :  api.addOnSettings.iconLibrary.nonce.load ,
              ...
              var __removeIconsFont = function(element){
                  ...
                  $.ajax({
                      ...
                      data:
                      {
                          ...
                          nonce         : api.addOnSettings.iconLibrary.nonce.remove ,
