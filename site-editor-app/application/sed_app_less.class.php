...
class SEDAppLess
{
	...
	function __construct() {
		...
		$constants = array(
			...
			'sed-framework-root'	=> sprintf( "\"%s\"", SED_BASE_URL. "libraries/less-framework/" ),
    ...
    static function compile_file( $file , $compiled_path , $less_base_module = true ){
        ...
        $base_path      = SED_BASE_DIR . DS .  'libraries' . DS . 'less-framework' . DS . 'module-base.less';
        ...
        $import_dir = array(
            SED_BASE_DIR . DS . 'applications'. DS . 'pagebuilder' . DS. 'modules'  => '' , // sed-modules-root
            SED_BASE_DIR . DS . 'libraries' . DS . 'less-framework'                 => '' , // sed-framework-root
            SED_BASE_DIR                                                            => '' , // sed-root
            SED_PLUGIN_DIR                                                          => '' , // sed-plugin-root
            SED_PLUGIN_DIR                                                          => '' , // sed-theme-root
        );

        require_once SED_BASE_DIR . DS . 'application' . DS . 'less.php' . DS . 'less.php';
    ...
    static function compile_base_framework( ){
        ...
        $less_framework = SED_BASE_DIR . DS .  'libraries' . DS . 'less-framework' . DS . 'siteeditor.less';
