...
class siteEditorFunctions{
    ...
    function __construct($registry) {
        ...
        $this->base_theme_url = SED_BASE_URL."templates/default/";
    ...
    function theme_scripts(){
        ...
        $site_editor_script->add("siteeditor-settings-render", $this->base_library_url."siteeditor/siteeditor-settings-render".$this->suffix.".js" , array( 'jquery', 'siteeditor') , "1.0.0",1 );
