...
*/
    ...
    $( "#sed-dialog-general-options" ).dialog({
        autoOpen: false,
        width: 295,
        height: 600 ,
        position      : {
    ...
    var initMultiLevelBox = false;

    $( "#page_general_settings" ).click(function() {
        $( "#sed-dialog-general-options" ).dialog( "open" );

        if( initMultiLevelBox === false){

            $(  "#sed-dialog-general-options"  ).multiLevelBoxPlugin({
              titleBar: $(  "#sed-dialog-general-options"  ).siblings(".ui-dialog-titlebar:first"),
              innerContainer : $(  "#sed-dialog-general-options"  ).find(".dialog-level-box-settings-container"),
            });

            $( "#sed-dialog-general-options"  ).siblings(".ui-dialog-titlebar:first").find(".close-page-box").livequery(function(){
                $(this).click(function(e){
                  $(  "#sed-dialog-general-options"  ).dialog( "close" );
                });
            });

            initMultiLevelBox = true;
        }
    });
