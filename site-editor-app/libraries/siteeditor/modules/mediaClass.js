...
/*global diagram:true */
define("siteEditor/modules/mediaLibrary",
    ...
    Library = api.SedMediaLibrary = api.Class.extend({
      ...
      initUploader : function(){
          ...
          var uploader = new plupload.Uploader({
              ...
              url                   : LIBBASE.url + "media/uploader/upload.php",
              flash_swf_url         : LIBBASE.url + "media/uploader/js/Moxie.swf",
              silverlight_xap_url   : LIBBASE.url + "media/uploader/js/Moxie.xap",
              filedataname          : "file",
    ...
    $( function() {
           ...
           /* yepnope({
                ...
                callback: function (url, result, key) {
                    ...
                    $('.img-library').livequery(function(){
