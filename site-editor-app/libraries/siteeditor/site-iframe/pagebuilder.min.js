        ...
        modulesSortable: function(){
            ...
            var options = {
                ...
                stop : function( event, ui ){
                    ...
                    api.Events.trigger( "moduleBeforeSortableStopEvent" , ui );
                    ...
                    if( ui.item.hasClass('sed-main-content-role') && ui.item.parents(".sed-main-content-row-role").length == 0 ){
