...
(function( window, settings ) {
	...
	if ( 'editor' in window.sedApp ) {
		//only change by site editor team for comptible with site editor
		//remove customize and add sedApp.editor
		/**
		* Selective refresh support in the Site Editor.
		* Wordpress Video Header Support
		* @param value
		* @returns {*}
		* @private
		*/
		sedApp.editor.selectiveRefresh.bind( 'render-partials-response', function( response ) {
			if ( 'custom_header_settings' in response ) {
			    settings = response.custom_header_settings;
			}
		});

		sedApp.editor.selectiveRefresh.bind( 'partial-content-rendered', function( placement ) {
			if ( 'header_video' === placement.partial.id || 'external_header_video' === placement.partial.id || 'header_image' === placement.partial.id ) {
