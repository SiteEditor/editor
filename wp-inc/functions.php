...
function load_page_builder_app(){
    ...
    include_once( SED_BASE_DIR . DS . 'application' . DS . "app_pb_modules.class.php"  );
    $pb_modules = new SEDPageBuilderModules( );
    $pb_modules->app_modules_dir = SED_BASE_DIR . DS . 'applications' . DS . 'pagebuilder' . DS . 'modules';
    $sed_pb_modules = $pb_modules;
    require_once SED_BASE_DIR . DS . 'applications' . DS . 'pagebuilder' . DS . 'index.php';
}
...
function sed_placeholder_img_src(){
    return apply_filters( 'adur_placeholder_img_src', SED_PLUGIN_URL . '/wp-inc/images/no_pic.png' );
}
