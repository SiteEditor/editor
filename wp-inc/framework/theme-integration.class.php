...
class SiteEditorWrapping {
  ...
  public function __toString() {
    ...
    if ( '' == $path ) {
      return SED_PLUGIN_DIR . "/wp-inc/framework/sed-base.php";
    } else {
      return $path;
    }
...
function sed_primary_template() {
  ...
  $wide_boxed_class = ( isset( $sed_data['page_length'] ) && $sed_data['page_length'] == "boxed" ) ? "sed-row-boxed" : "sed-row-wide";
  ?>
    <div id="page" class="hfeed site" sed-role="layout">
      <div id="main" class="site-main bp-component sed-pb-post-container <?php echo $wide_boxed_class;?>" data-post-id="<?php echo $sed_data['page_id'];?>" data-parent-id="root" data-page-type="<?php echo $sed_data['page_type'];?>" data-content-type="theme"  sed-layout="row" sed-type-row="static" sed-role="main-content">
        <?php
