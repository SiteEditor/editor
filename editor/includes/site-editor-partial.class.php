<?php
/**
 * Customize API: SiteEditorPartial class
 *
 * @package WordPress
...
class SiteEditorPartial {
	 ...
	 * @since 4.5.0
	 * @access public
	 * @var SiteEditorSelectiveRefresh
	 */
	public $component;
	 ...
	 * @since 4.5.0
	 * @access public
	 * @see SiteEditorPartial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *                 SiteEditorPartial. The callback can either echo the
	 ...
	 * @access public
	 *
	 * @param SiteEditorSelectiveRefresh $component Customize Partial Refresh plugin instance.
	 ...
	 * }
	 */
	public function __construct( SiteEditorSelectiveRefresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param SiteEditorPartial $partial           WP_Customize_Setting instance.
		 * @param array                $container_context Optional array of context data associated with
		 *                                                the target container.
		 */
		$rendered = apply_filters( 'sed_app_partial_render', $rendered, $partial, $container_context );
		 ...
		 *                                                the target container.
		 */
		$rendered = apply_filters( "sed_app_partial_render_{$partial->id}", $rendered, $partial, $container_context );
	 ...
	 * @access public
	 *
	 * @param SiteEditorPartial $partial Partial.
	 * @param array                $context Context.
	 * @return string|array|false
	 */
	public function render_callback( SiteEditorPartial $partial, $context = array() ) {
