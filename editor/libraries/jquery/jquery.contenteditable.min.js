		...
		field : function( parent ) {
			...
			return this.each(function() {
				...
				$this.on('focus', function() {
					var $this = $(this) , content = ( format == "html" ) ? $this.html(): $this.text();
					$this.data('enter', content);
					$this.data('before', content);
					return $this;
				}).on('keyup paste', function() {
					var $this = $(this);
					var text = ( format == "html" ) ? $this.html(): $this.text();
					if ($this.data('before') !== text) {
						$this.data('before', text);
						var data = {};
						data[key] = text;
						$this.trigger({type: 'change', action : 'update', changed: data, changedField: $this});
					}
					return $this;
				}).on('blur', function() {
					var $this = $(this);
					...
					if ($this.data('enter') !== text) {
						...
						var data = {};
						data[key] = text;
						$this.trigger({type: 'change', action : 'save', changed: data, changedField: $this});
					}
					return $this;
				})
			});
