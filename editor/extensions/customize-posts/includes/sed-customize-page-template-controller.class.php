<?php
/**
 * SiteEditor Customize Page Template Controller Class
 *
 * @package WordPress
...
/**
 * Class SiteEditorPageTemplateController
 */
class SiteEditorPageTemplateController extends SiteEditorPostmetaController {
	 ...
	 */
	public function sanitize_setting( $page_template, SiteEditorPostmetaSetting $setting ) {
		$post = get_post( $setting->post_id );
		$page_templates = wp_get_theme()->get_page_templates( $post );
		$has_setting_validation = method_exists( 'SedAppSettings', 'validate' );

		if ( 'default' !== $page_template && ! isset( $page_templates[ $page_template ] ) ) {
			return $has_setting_validation ? new WP_Error( 'invalid_page_template', __( 'The page template is invalid.', 'site-editor' ) ) : null;
		}
