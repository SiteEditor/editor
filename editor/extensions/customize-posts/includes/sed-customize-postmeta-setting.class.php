...
class SiteEditorPostmetaSetting extends SedAppSettings {
	...
	/**
	 * SiteEditorPostmetaSetting constructor.
	 *
	 * @access public
	 *
	...
	public function sanitize( $meta_value ) {
		 ...
		 */
		$meta_value = apply_filters( "sed_app_sanitize_setting", $meta_value , $this );

		$meta_value = apply_filters( "sed_app_sanitize_{$this->id}", $meta_value, $this );
	 ...
	 *
	 * Note that the previewing logic is handled by SiteEditorCustomizePostsPreview.
	 *
	 * @access public
	 *
	 * @return bool
