<?php
/**
 * SiteEditor Customize Postmeta Controller Class
 *
 * @package WordPress
 ...
 */
abstract class SiteEditorPostmetaController {
	...
	public function __construct( $args = array() ) {
		...
		add_action( 'sed_enqueue_scripts', array( $this, 'enqueue_sed_app_pane_scripts' ) );
	 ...
	 */
	abstract public function enqueue_sed_app_pane_scripts();
	...
	public function sed_app_preview_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'enqueue_sed_app_preview_scripts' ) );
	}
	 ...
	 */
	public function enqueue_sed_app_preview_scripts() {}
