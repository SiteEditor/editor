...
(function( exports, $ ){
    ...
    api.AppSettings = api.Class.extend({
        ...
        view : function(){
            ...
            api.addFilter( 'sedAjaxLoadOptionsDataFilter' , function( data ){
                if( data.options_group == "sed_content_options" ){
            ...
            api.addFilter( 'sedAjaxLoadOptionsDataFilter' , function( data ){
                if( data.options_group == "sed_page_options" ){
            ...
            $( self.selector ).find("#sed-app-control-sed_page_options_scope .buttonset-label").livequery(function(){
                ...
                $(this).on( "click.pageOptionsScope" , function(){
                    __tabScope( $(this) );
                });

            }, function() {
                // unbind the change event
                $(this).unbind('click.pageOptionsScope');
            });
            ...
            api.Events.bind( "afterAppendSettingsTmpl" , function( currentElDialog , settingsType , settingsId ){
                ...
                api.Events.trigger("after_group_settings_update", currentPageSettingsId);

            });

            //update sed page options group after refresh page & open dialog settings
            api.Events.bind( "endInitAppendSettingsTmpl" , function( currentElDialog , settingsType , settingsId ){
        ...
        openInitDialogSettings : function( optionsGroup , forceOpen , reset ){
