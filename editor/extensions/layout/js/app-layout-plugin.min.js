...
(function( exports, $ ){
    ...
    api.AppLayouts = api.Class.extend({
        ...
        createThemeContent : function(){
            var control = this ,
                pagesThemeContent = api.sedShortcode.clone( api.pagesThemeContent[api.settings.page.id] );

            console.log( "----------------pagesThemeContent NEW NEW -------------" , pagesThemeContent );
            ...
            _.each( api.pagesThemeContent[api.settings.page.id] , function( shortcode , index ){
                ...
                if( !_.isUndefined( shortcode.theme_id ) && _.isUndefined( shortcode.is_customize ) ){
                    ...
                    var rowShortcodes = api.sedShortcode.findModelsById( pagesThemeContent , shortcode.id );

                    var moduleLength = rowShortcodes.length;

                    var currIndex = api.sedShortcode.index( shortcode.id , pagesThemeContent );

                    pagesThemeContent.splice( currIndex , moduleLength );
    ...
    api.LayoutScopeControl = api.Control.extend({
        ...
        update: function (themeId) {
            ...
            if (_.isEmpty(layouts)) {
                ...
                //alert( $(control.selector).find('.sub-theme-item input[value="' + control.currentLayout + '"]').length );
