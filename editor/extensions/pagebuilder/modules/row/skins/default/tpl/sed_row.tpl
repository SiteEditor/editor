...
<# }else{ #>
      <div sed-layout-role="pb-module" class="sed-row-pb sed-bp-element {{className}} {{lengthClass}} {{sed_contextmenu_class}}" {{sed_attrs}} data-type-row="{{type}}" length_element sed-role="row-pb">
