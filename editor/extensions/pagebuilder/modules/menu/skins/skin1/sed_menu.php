...
<div <?php echo $sed_attrs; ?> class="<?php echo $class.' '.$sticky_styles ?> <?php echo ( $orientation == 'vertical'  ? 'vertical-megamenu' : '' )  ?> navbar-wrap module module-megamenu megamenu-skin1 " >
