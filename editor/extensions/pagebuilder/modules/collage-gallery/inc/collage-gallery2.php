            ...
            'group_skin'     =>  array(
                ...
                'js_params' =>  array(
                    "support"  =>  array(
                        "type"     =>  "exclude" ,
                        "fields"   =>  array(
                            "tape-style" ,"circle" , "circle-spinner" , "cutout-style" , "simple-circle" , "square","simple-square"
                         )
                    )
                ),
                'panel'    => 'images_settings_panel',
...
<<<<<<< .mine
    function relations(){
        ...
        $relations = array(                                       //
            //'collage-image_group_hover_effect' => $this->hover_effect_relations( "collage-image_group_skin" ),
            'group_images_image_click' => array(
                'values'   =>  array(
                    'link_expand_mode'  =>  array(
                            "control"  =>  "collage-image_group_hover_effect" ,
                            "values"    =>  array(
                                 '' , 'img-reset-sepia,img-reset-sepia' , 'img-reset-blur,img-reset-blur' , 'img-reset-greyscale,img-reset-greyscale'
                            ),
                            "type"     =>  "exclude"
                    ),
    ...
    function supports(){
        $supports = array(
            "subShortcode"  => array(
                "image-collage-gallery"  =>  array(

                    "settings"  =>  array(
                        "type"     =>  "include" ,
                        "fields"   =>  array( 'src' , 'image_click' , 'using_size' , 'show_title' , 'title' , 'alt' , 'show_description' , 'description' , 'skin' , 'hover_effect' , 'link_target' , 'link'  )
                    ) ,
                    ...
                    "skins"  =>  array(
                        "type"     =>  "exclude" ,
                        "fields"   =>  array(
                            "tape-style","square","simple-square" ,"circle" , "circle-spinner" , "cutout-style" , "simple-circle"
