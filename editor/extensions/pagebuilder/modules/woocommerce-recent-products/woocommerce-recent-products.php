...
/*
* Module Name: Woocommerce recent products
* Module URI: http://www.siteeditor.org/modules/woocommerce-recent-products
* Description: Woocommerce recent products Module For Site Editor Application
...
if( !is_pb_module_active( "woocommerce-archive" )  || !is_pb_module_active( "woocommerce-content-product" ) ){
    sed_admin_notice( __("<b>Woocommerce Recent Products module</b> needed to <b>woocommerce archive module</b> and <b>woocommerce content product module</b> <br /> please first install and activate its ") );
    return ;
}

class PBWoocommerceRecentProductsShortcode extends PBShortcodeClass{
    ...
    function __construct() {
        parent::__construct( array(
                "name"        => "sed_recent_products",                               //*require
                "title"       => __("Woo recent products","site-editor"),                 //*require for toolbar
                "description" => __("Woocommerce recent products","site-editor"),
                "icon"        => "icon-woo",                               //*require for icon toolbar
                "module"      =>  "woocommerce-recent-products",         //*require
        ...
        $this->sed_woo_shortcode = new SedWoocommerceShortcode( "recent_products" , $this );
    ...
    function contextmenu( $context_menu ){
      $archive_menu = $context_menu->create_menu( "woo-recent-products" , __("Woo Recent Products","site-editor") , 'woo-recent-products' , 'class' , 'element' , '' , "sed_recent_products" , array(
...
new PBWoocommerceRecentProductsShortcode();
...
$sed_pb_app->register_module(array(
    ...
    "title"       => __("Woo recent products","site-editor"),
    "description" => __("Woocommerce recent products","site-editor"),
    "icon"        => "icon-woo",
    "type_icon"   => "font",
    "shortcode"         => "sed_recent_products",
    "transport"   => "ajax" ,
