...
<div {{sed_attrs}} class="sed-api-test module module-api-test-module api-test-module-skin-default sed-sas-md {{className}}" length_element="sed-row-wide" >
    ...
    <div>
        ...
        <div><span class="attr">Multicolor control:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="value">{{multi_color_field_id}}</span></div>
        ...
        #>  
        <div><span class="attr">SED Image Field:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="value">{{{sedImageHtml}}}</span></div>
        <div>
            <span class="attr">Number Settings</span><br>
        ...
        <div><span class="attr">Single Image Field:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="value">{{{imageHtml}}}</span></div>
