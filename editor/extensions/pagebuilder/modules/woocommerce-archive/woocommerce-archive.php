...
class PBWoocommerceArchiveShortcode extends PBShortcodeClass{
    ...
    function __construct() {
        ...
        add_action( 'sed_editor_init', array( $this , 'add_woo_toolbar_group' ) ,10 , 1);

        add_action( 'sed_editor_init', array( $this , 'add_woo_group_toolbar' ) , 10 , 1 );
    ...
    function add_woo_group_toolbar(){
    ...
    function add_woo_toolbar_group( ){
        global $site_editor_app;
