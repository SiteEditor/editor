    ...
    function shortcode_settings(){
        ...
        $settings = array(
            "category"      => array(
                ...
                "desc"      => __('This option allows you to set the categories of your products.',"site-editor"),
            ...
            "operator"      => array(
                ...
                "desc"      => __('This option allows you to set how the category groups should be handled. ',"site-editor"),
                "options"   => array(
