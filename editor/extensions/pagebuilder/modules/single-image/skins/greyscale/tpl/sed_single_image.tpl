...
<div {{sed_attrs}} class="module module-single-image single-image-greyscale {{className}}">

    <# if(image_click == "expand_mode"){ #>
        <a class="img roma" href="{{full_src}}" data-lightbox="{{lightbox_id}}" data-title="{{title}}" title="{{title}}">
        {{{sedImageHtml}}}
        </a>
    <# } #>

    <# if(image_click == "link_mode" || image_click == "link_expand_mode" ){ #>
        <a class="img roma" href="{{link}}" target="{{link_target}}" title="{{title}}">
        {{{sedImageHtml}}}
        </a>
    <# } #>
