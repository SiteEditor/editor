...
?>
<div <?php echo $sed_attrs; ?> class="sed-stb-sm sed-ta-c module module-single-image single-image-greyscale <?php echo $class;?>">   
    ...
    <a class="img" href="<?php echo $full_src;?>" data-lightbox="<?php if(!empty($lightbox_id)) echo $lightbox_id;else echo $id;?>" data-title="<?php echo $title;?>" title="<?php echo $title;?>">
       <img class="sed-img roma"  src="<?php echo $src;?>" alt="<?php echo $alt;?>">
    </a>
    <?php } ?>
