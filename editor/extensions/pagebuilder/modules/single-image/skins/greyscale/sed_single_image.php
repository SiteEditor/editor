...
<div <?php echo $sed_attrs; ?> class="module module-single-image single-image-greyscale <?php echo $class;?>">  

    <?php if($image_click == "expand_mode"){ ?>
        <a class="img roma" href="<?php echo $attachment_full_src;?>" data-lightbox="<?php if( !empty($lightbox_id) ) echo $lightbox_id;else echo "sed-lightbox";?>" data-title="<?php echo $title;?>" title="<?php echo $title;?>">
           <?php echo $img['thumbnail'];?>
        </a>
    <?php } ?>

    <?php if($image_click == "link_mode" || $image_click == "link_expand_mode" ){ ?>
        <a class="img roma"  href="<?php echo $link;?>" target="<?php echo $link_target;?>" title="<?php echo $title;?>">
            <?php echo $img['thumbnail'];?>
        </a>
    <?php } ?>
