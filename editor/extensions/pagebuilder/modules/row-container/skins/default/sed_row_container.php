...
if(!empty($content)){?>
       <div class="sed-stb-sm row-container-module <?php echo $class.' '.$responsive_option;?> <?php if($is_arrow) echo $arrow; ?> <?php if($overlay){?>row-overlay<?php } ?> <?php if($full_height){?>row-flex row-full-height<?php } ?> <?php echo $length_class;?>" <?php echo $sed_attrs; ?> length_element>
