...
(function( exports, $ ){
    ...
    api.MulticolorControl = api.SiteEditorControls.extend({
        ...
        _ready: function() {
            ...
            var _refresh = function( color , key ){
                ...
                control.model[key] = color;

                var newVal = $.extend( true , {} , control.model );
    ...
    api.CodeControl = api.SiteEditorControls.extend({
        ...
        _ready: function() {
            ...
            if( control.params.updateType == 'auto-change' ) {
                ...
                this.editor.on('change', function () {
                    control.refresh( control.editor.getValue() );
                });
            }else{
        ...
        toExpand : function(){
            ...
            control.editor.setSize( "100%" , "600px" );

            $("#sed-dialog-settings").dialog("option", "width", 600);

            $(this).addClass( "sed-expanded-toggle" );

            this.container.find(".sed-resize-code-editor-toggle").addClass( "sed-code-editor-expanded" );
