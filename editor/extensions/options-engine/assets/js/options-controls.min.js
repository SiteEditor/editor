...
(function( exports, $ ){
    ...
    api.SortableControl = api.SiteEditorControls.extend({
        ...
        _ready: function() {
            ...
            sortableUl.sortable({
		      ...
		      update: function( event, ui ) {
				...
				sortableUl.find( 'li.sed-bp-form-sortable-item' ).each( function() {
					var $this = $( this );
					values.push( $this.data( 'value' ) );
				});
                control._setValue(values);
		...
		_setValue: function( newValue ) {
			...
			this.refresh( newValueSerialized );
		}
    ...
    api.CodeControl = api.SiteEditorControls.extend({
        ...
        _ready: function() {
			...
			SedCodeMirror.on( 'change', function() {
				control.refresh( SedCodeMirror.getValue() );
			});
        ...
        _update: function( val ){ 
			...
			//this.SedCodeMirror.setValue(val); 
