<?php
/**
 * Additional sanitize methods for settings & controls
 * These are used in the field's 'sanitize_callback' argument.
 *
 * Implements additional sanitize methods in the SiteEditor Application.
 *
 * @package SiteEditor
 * @subpackage Options
 */
...
if ( ! class_exists( 'SiteEditorSanitizeSettings' ) ) {

	/**
	 * A simple wrapper class for static methods.
	 *
	 * Class SiteEditorSanitizeSettings
	 */
	class SiteEditorSanitizeSettings {
		...
		public static function __callStatic( $name, $arguments ) {
			error_log( "SiteEditorSanitizeSettings::$name does not exist" );
			return $arguments;
		}
