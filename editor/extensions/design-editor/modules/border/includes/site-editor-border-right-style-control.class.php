<?php
/**
 * SiteEditor Control: border-right-style.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderRightStyleControl' ) ) {

 
	/**
	 * Border Right Style control 
	 *
	 * Class SiteEditorBorderRightStyleControl
	 */
	class SiteEditorBorderRightStyleControl extends SiteEditorOptionsControl {
		 ...
		 * @var string
		 */
		public $type = 'border-right-style';
         ...
         * @var string
         */
        public $style_props = "border-right-style";
        ...
        protected function render_content() {
            ...
            $border_style_control = $this->id . "_border_right_style";
...
sed_options()->register_control_type( 'border-right-style' , 'SiteEditorBorderRightStyleControl' );
