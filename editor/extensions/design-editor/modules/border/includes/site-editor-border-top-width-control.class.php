<?php
/**
 * SiteEditor Control: border-top-width.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderTopWidthControl' ) ) {
	 ...
	 *
	 * Class SiteEditorBorderTopWidthControl
	 */
	class SiteEditorBorderTopWidthControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "border-top-width";
...
sed_options()->register_control_type( 'border-top-width' , 'SiteEditorBorderTopWidthControl' );
