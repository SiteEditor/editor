<?php
/**
 * SiteEditor Control: border-right-width.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderRightWidthControl' ) ) {
	...
	/**
	 * Border Right Width control 
	 *
	 * Class SiteEditorBorderRightWidthControl
	 */
	class SiteEditorBorderRightWidthControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "border-right-width";
...
sed_options()->register_control_type( 'border-right-width' , 'SiteEditorBorderRightWidthControl' );
