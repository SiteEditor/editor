<?php
/**
 * SiteEditor Control: border-left-color.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderLeftColorControl' ) ) {
	...
	/**
	 * Border Left Color control 
	 *
	 * Class SiteEditorBorderLeftColorControl
	 */
	class SiteEditorBorderLeftColorControl extends SiteEditorColorControl {
         ...
         * @var string
         */
        public $style_props = "border-left-color";
...
sed_options()->register_control_type( 'border-left-color' , 'SiteEditorBorderLeftColorControl' );
