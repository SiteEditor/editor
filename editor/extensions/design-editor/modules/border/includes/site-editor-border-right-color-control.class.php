<?php
/**
 * SiteEditor Control: border-right-color.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderRightColorControl' ) ) {
	...
	/**
	 * Border Right Color control 
	 *
	 * Class SiteEditorBorderRightColorControl
	 */
	class SiteEditorBorderRightColorControl extends SiteEditorColorControl {
		 ...
		 * @var string
		 */
		public $type = 'border-right-color';
         ...
         * @var string
         */
        public $style_props = "border-right-color";
...
sed_options()->register_control_type( 'border-right-color' , 'SiteEditorBorderRightColorControl' );
