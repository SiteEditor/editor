<?php
/**
 * SiteEditor Control: border-color.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderColorControl' ) ) {
	 ...
	 *
	 * Class SiteEditorBorderColorControl
	 */
	class SiteEditorBorderColorControl extends SiteEditorColorControl {
...
sed_options()->register_control_type( 'border-color' , 'SiteEditorBorderColorControl' );
