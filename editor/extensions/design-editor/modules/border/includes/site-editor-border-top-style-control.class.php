<?php
/**
 * SiteEditor Control: border-top-style.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderTopStyleControl' ) ) {
	 ...
	 */
	class SiteEditorBorderTopStyleControl extends SiteEditorOptionsControl {
         ...
         * @var string
         */
        public $style_props = "border-top-style";
        ...
        protected function render_content() {
            ...
            $border_style_control = $this->id . "_border_top_style";
...
sed_options()->register_control_type( 'border-top-style' , 'SiteEditorBorderTopStyleControl' );
