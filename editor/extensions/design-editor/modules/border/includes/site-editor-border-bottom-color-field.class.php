<?php
/**
 * SiteEditor Field: border-bottom-color.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderBottomColorField' ) ) {
     ...
     * Field overrides.
     */
    class SiteEditorBorderBottomColorField extends SiteEditorColorField { 
         ...
         * @var string
         */
        public $setting_id = 'border_bottom_color';
...
sed_options()->register_field_type( 'border-bottom-color' , 'SiteEditorBorderBottomColorField' );
