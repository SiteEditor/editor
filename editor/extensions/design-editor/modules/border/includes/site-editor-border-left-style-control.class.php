<?php
/**
 * SiteEditor Control: border-left-style.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderLeftStyleControl' ) ) {

 
	/**
	 * Border Left Style control 
	 *
	 * Class SiteEditorBorderLeftStyleControl
	 */
	class SiteEditorBorderLeftStyleControl extends SiteEditorOptionsControl {
         ...
         * @var string
         */
        public $style_props = "border-left-style";
        ...
        protected function render_content() {
            ...
            $border_style_control = $this->id . "_border_left_style";
...
sed_options()->register_control_type( 'border-left-style' , 'SiteEditorBorderLeftStyleControl' );
