<?php
/**
 * SiteEditor Control: border-top-color.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderTopColorControl' ) ) {
	...
	/**
	 * Border Top Color control 
	 *
	 * Class SiteEditorBorderTopColorControl
	 */
	class SiteEditorBorderTopColorControl extends SiteEditorColorControl {
         ...
         * @var string
         */
        public $style_props = "border-top-color";
...
sed_options()->register_control_type( 'border-top-color' , 'SiteEditorBorderTopColorControl' );
