<?php
/**
 * SiteEditor Control: border-left-width.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderLeftWidthControl' ) ) {
	...
	/**
	 * Border Left Width control 
	 *
	 * Class SiteEditorBorderLeftWidthControl
	 */
	class SiteEditorBorderLeftWidthControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "border-left-width";
...
sed_options()->register_control_type( 'border-left-width' , 'SiteEditorBorderLeftWidthControl' );
