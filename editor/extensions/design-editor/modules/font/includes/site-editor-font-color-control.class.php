...
if ( ! class_exists( 'SiteEditorFontColorControl' ) ) {
	 ...
	 * Font Color control
	 *
	 * Class SiteEditorFontColorControl
	 */
	class SiteEditorFontColorControl extends SiteEditorColorControl {
...
sed_options()->register_control_type( 'font-color' , 'SiteEditorFontColorControl' );
