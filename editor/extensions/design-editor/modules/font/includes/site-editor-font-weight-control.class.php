<?php
/**
 * SiteEditor Control: font-weight.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorFontWeightControl' ) ) {
	 ...
	 * Font Weight control 
	 *
	 * Class SiteEditorFontWeightControl
	 */
	class SiteEditorFontWeightControl extends SiteEditorSelectControl {
         ...
         * @var string
         */
        public $style_props = "font-weight";
...
sed_options()->register_control_type( 'font-weight' , 'SiteEditorFontWeightControl' );
