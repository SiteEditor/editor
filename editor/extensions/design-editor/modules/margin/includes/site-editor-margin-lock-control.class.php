<?php
/**
 * SiteEditor Control: margin-lock.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorMarginLockControl' ) ) {
	 ...
	 */
	class SiteEditorMarginLockControl extends SiteEditorCheckboxControl {
         ...
         * @var string
         */
        public $style_props = "margin-lock";
...
sed_options()->register_control_type( 'margin-lock' , 'SiteEditorMarginLockControl' );
