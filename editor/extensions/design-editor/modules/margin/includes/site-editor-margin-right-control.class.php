<?php
/**
 * SiteEditor Control: margin-right.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorMarginRightControl' ) ) {
	 ...
	 *
	 * Class SiteEditorMarginRightControl
	 */
	class SiteEditorMarginRightControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "margin-right";
...
sed_options()->register_control_type( 'margin-right' , 'SiteEditorMarginRightControl' );
