...
if ( ! class_exists( 'SiteEditorMarginTopControl' ) ) {
	 ...
	 * Margin Top control 
	 *
	 * Class SiteEditorMarginTopControl
	 */
	class SiteEditorMarginTopControl extends SiteEditorNumberControl {
...
sed_options()->register_control_type( 'margin-top' , 'SiteEditorMarginTopControl' );
