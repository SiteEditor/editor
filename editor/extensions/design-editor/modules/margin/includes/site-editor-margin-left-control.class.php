<?php
/**
 * SiteEditor Control: margin-left.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorMarginLeftControl' ) ) {
	 ...
	 * Margin Left control 
	 *
	 * Class SiteEditorMarginLeftControl
	 */
	class SiteEditorMarginLeftControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "margin-left";
...
sed_options()->register_control_type( 'margin-left' , 'SiteEditorMarginLeftControl' );
