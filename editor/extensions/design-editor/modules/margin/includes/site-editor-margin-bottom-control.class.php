<?php
/**
 * SiteEditor Control: margin-bottom.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorMarginBottomControl' ) ) {
	 ...
	 *
	 * Class SiteEditorMarginBottomControl
	 */
	class SiteEditorMarginBottomControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "margin-bottom";
...
sed_options()->register_control_type( 'margin-bottom' , 'SiteEditorMarginBottomControl' );
