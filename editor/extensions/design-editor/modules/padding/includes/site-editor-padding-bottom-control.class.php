<?php
/**
 * SiteEditor Control: padding-bottom.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorPaddingBottomControl' ) ) {
	 ...
	 *
	 * Class SiteEditorPaddingBottomControl
	 */
	class SiteEditorPaddingBottomControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "padding-bottom";
...
sed_options()->register_control_type( 'padding-bottom' , 'SiteEditorPaddingBottomControl' );
