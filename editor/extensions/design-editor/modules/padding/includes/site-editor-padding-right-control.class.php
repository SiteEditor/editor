<?php
/**
 * SiteEditor Control: padding-right.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorPaddingRightControl' ) ) {
	 ...
	 *
	 * Class SiteEditorPaddingRightControl
	 */
	class SiteEditorPaddingRightControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "padding-right";
...
sed_options()->register_control_type( 'padding-right' , 'SiteEditorPaddingRightControl' );
