...
if ( ! class_exists( 'SiteEditorPaddingField' ) ) {
     ...
     * Field overrides.
     */
    class SiteEditorPaddingField extends SiteEditorNumberField { 
        ...
        protected function set_setting_id() {
            ...
            if ( ! empty( $this->prop_side ) ) {
                $this->setting_id = "padding_{$this->prop_side}";
            }
...
sed_options()->register_field_type( 'padding' , 'SiteEditorPaddingField' );
