...
if ( ! class_exists( 'SiteEditorPaddingControl' ) ) {
	 ...
	 * Padding Top control 
	 *
	 * Class SiteEditorPaddingControl
	 */
	class SiteEditorPaddingControl extends SiteEditorNumberControl {
        ...
        public function json() {
            ...
            if ( empty( $this->prop_side ) ){
                $this->style_props = "padding-{$this->prop_side}";
            }
...
sed_options()->register_control_type( 'padding' , 'SiteEditorPaddingControl' );
