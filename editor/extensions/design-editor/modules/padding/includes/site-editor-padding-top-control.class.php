<?php
/**
 * SiteEditor Control: padding-top.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorPaddingTopControl' ) ) {
	 ...
	 * Padding Top control 
	 *
	 * Class SiteEditorPaddingTopControl
	 */
	class SiteEditorPaddingTopControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "padding-top";
...
sed_options()->register_control_type( 'padding-top' , 'SiteEditorPaddingTopControl' );
