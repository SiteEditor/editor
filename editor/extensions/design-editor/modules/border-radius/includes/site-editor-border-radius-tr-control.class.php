<?php
/**
 * SiteEditor Control: border-radius-tr.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderRadiusTopRightControl' ) ) {
	...
	/**
	 * Border Radius Top Right control 
	 *
	 * Class SiteEditorBorderRadiusTopRightControl
	 */
	class SiteEditorBorderRadiusTopRightControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "border-top-right-radius";
...
sed_options()->register_control_type( 'border-radius-tr' , 'SiteEditorBorderRadiusTopRightControl' );
