<?php
/**
 * SiteEditor Control: border-radius-br.
 *
 * @package     SiteEditor
 * @subpackage  Options
 * @since       1.0.0
...
if ( ! class_exists( 'SiteEditorBorderRadiusBottomRightControl' ) ) {
	...
	/**
	 * Border Radius Bottom Right control 
	 *
	 * Class SiteEditorBorderRadiusBottomRightControl
	 */
	class SiteEditorBorderRadiusBottomRightControl extends SiteEditorNumberControl {
         ...
         * @var string
         */
        public $style_props = "border-bottom-right-radius";
...
sed_options()->register_control_type( 'border-radius-br' , 'SiteEditorBorderRadiusBottomRightControl' );
