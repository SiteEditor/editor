...
class lessc {
	...
	protected function compileValue($value) {
		...
		if( $this->site_editor_app && isset( $value['tpl'] ))
			return $value['tpl'];
		...
		case 'color':
			...
			if ( isset( $value[4] ) && $value[4] != 1) { // rgba
	...
	protected function reduce($value, $forExpression = false) {
		...
		case "variable":
			...
			if( $this->site_editor_app )
				$out['tpl'] = '{{'.substr($key, 1).'}}';
	...
	protected function set($name, $value) {
		...
		$this->allVariable = array_merge( $this->allVariable , $this->env->store );
	}
	 ...
	 * $opts isn't used yet
	 */
	public function __construct( $SED = false , $fname = null) {
		if ($fname !== null) {
			// used for deprecated parse method
			$this->_parseFile = $fname;
		}
		$this->site_editor_app = $SED ;
	}
