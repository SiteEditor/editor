...
class SEDAppLess
{
    ...
    static function compile_file( $file , $compiled_path , $less_base_module = true ){
        ...
        $base_path      = SED_EDITOR_DIR . DS .  'libraries' . DS . 'less-framework' . DS . 'module-base.less';
        ...
        $import_dir = array(
            SED_EDITOR_DIR . DS . 'applications'. DS . 'pagebuilder' . DS. 'modules'  => '' , // sed-modules-root
            SED_EDITOR_DIR . DS . 'libraries' . DS . 'less-framework'                 => '' , // sed-framework-root
            SED_EDITOR_DIR                                                            => '' , // sed-root
            SED_PLUGIN_DIR                                                          => '' , // sed-plugin-root
            SED_PLUGIN_DIR                                                          => '' , // sed-theme-root
        );

        require_once SED_EDITOR_DIR . DS . 'application' . DS . 'less.php' . DS . 'less.php';
    ...
    static function compile_base_framework( ){
        ...
        $less_framework = SED_EDITOR_DIR . DS .  'libraries' . DS . 'less-framework' . DS . 'siteeditor.less';
