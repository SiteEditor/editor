...
class SiteEditorScript{
    ...
    */
    ...
    function default_scripts(){
        ...
        //$this->add( 'backbone', $this->base_library_url.'backbone/backbone-min.js', array( 'underscore' ), '1.3.3' );
        ...
        $this->add("siteeditor", $upload_url."/site-editor/siteeditor".$this->suffix.".js" , array('jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker' ) , "1.0.0" );

        $this->add("siteEditorControls", $this->base_library_url."siteeditor/core/siteEditorControls.js" , array('siteeditor' , 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("styleEditorControls", $this->base_library_url."siteeditor/core/styleEditorControls.js" , array( 'siteEditorControls', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("pbModulesControls", $this->base_library_url."siteeditor/core/pbModulesControls.js" , array( 'styleEditorControls', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("mediaClass", $this->base_library_url."siteeditor/modules/mediaClass.js" , array( 'pbModulesControls', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("appPreviewClass", $this->base_library_url."siteeditor/modules/appPreviewClass.js" , array( 'mediaClass', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("appTemplateClass", $this->base_library_url."siteeditor/modules/appTemplateClass.js" , array( 'appPreviewClass', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("pagebuilder", $this->base_library_url."siteeditor/plugins/pagebuilder/plugin.min.js" , array( 'appTemplateClass', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("contextmenu", $this->base_library_url."siteeditor/plugins/contextmenu/plugin.min.js" , array( 'pagebuilder', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("sed-settings", $this->base_library_url."siteeditor/plugins/settings/plugin.min.js" , array( 'contextmenu', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
        $this->add("sed-save", $this->base_library_url."siteeditor/plugins/save/plugin.min.js" , array( 'sed-settings', 'jquery' , "siteeditor-modules-scripts"  , 'siteeditor-ajax' , 'siteeditor-css', 'undomanager' , 'sed-undomanager', 'seduploader', 'bootstrap' , 'jquery-ui-full' , 'sed-colorpicker','underscore' ) , "1.0.0" );
