...
class SiteEditorPreset{
    ...
    public function __construct(){
        ...
        add_action( "sed_footer" , array( $this , 'print_default_presets' ) , 10  );
    }
    ...
    public function add_js_plugin() {
        wp_register_script("sed-app-preset", SED_EDITOR_FOLDER_URL . 'applications/siteeditor/modules/a-preset/assets/js/app-preset-plugin.min.js' , array(  ) , "1.0.0",1 );
        wp_enqueue_script( 'sed-app-preset' );
    }

    public function render_scripts(){
        wp_enqueue_script( 'app-preset-module', SED_EDITOR_FOLDER_URL . 'applications/siteeditor/modules/a-preset/assets/js/app-preset-module.min.js', array( 'siteeditor-base' , 'sed-app-preview' , 'sed-pagebuilder' ) ,"1.0.0" , 1);
    }
    ...
    public static function create_preset_content( $content_shortcodes ){
        ...
        global $sed_apps;
        $tree_shortcodes = $sed_apps->app_save->build_tree_shortcode( $content_shortcodes , $content_shortcodes[0]['parent_id'] );
        $content = $sed_apps->app_save->create_shortcode_content( $tree_shortcodes , array() );
