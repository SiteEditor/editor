...
if(!class_exists('SiteEditorLayoutManager')){
    class SiteEditorLayoutManager{
        ...
        public function add_js_plugin() {
            wp_register_script("sed-app-layout", SED_EDITOR_FOLDER_URL . 'applications/siteeditor/modules/layout/js/app-layout-plugin.min.js' , array(  ) , "1.0.0",1 );
        ...
        public function render_scripts(){
            wp_enqueue_script( 'app-layout-module', SED_EDITOR_FOLDER_URL . 'applications/siteeditor/modules/layout/js/app-layout-module.min.js', array( 'siteeditor-base' , 'sed-app-preview' , 'sed-pagebuilder' ) ,"1.0.0" , 1);
            //wp_register_script( 'sub-themes-plugin',SED_EDITOR_FOLDER_URL.'libraries/siteeditor/site-iframe/plugins/app-sub-themes.min.js', array( 'siteeditor-base' , 'sed-app-preview' , 'sed-pagebuilder' ),"",1 );
