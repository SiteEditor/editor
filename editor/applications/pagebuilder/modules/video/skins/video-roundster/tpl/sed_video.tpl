<div {{sed_attrs}} class="{{class}} s-tb-sm ta-c module video-module video-module-roundster" {{has_cover}}>
	<div class="breake-point"></div><!-- a helper element to go get the media queries on js :) -->
	<div id="jp_container_{{sed_model_id}}" class="sed_jp_container jp-video">
