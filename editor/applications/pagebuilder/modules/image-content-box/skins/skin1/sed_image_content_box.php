<div <?php echo $sed_attrs; ?> class="s-tb-sm module module-image-content-box image-content-box-skin1 <?php echo $class  ;?>" >
    <div class="item">
...
<?php
	...
	?> 
		...
		<?php echo $selector; ?> .img-item{
		    padding: <?php echo $item_img; ?>px 0 <?php echo $item_img; ?>px <?php echo $item_img; ?>px;
		}
