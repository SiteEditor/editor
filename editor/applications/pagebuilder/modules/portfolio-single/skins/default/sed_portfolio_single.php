...
?>
<div <?php echo $sed_attrs; ?> data-contextmenu-post-id="<?php echo get_the_ID();?>" data-sed-post-role="post-module-container" class="module single-portfolio single-portfolio-default <?php echo $classes; ?> <?php echo $class  ;?>">
<?php
  // Start the Loop.
  //if ( have_posts() ) :
      echo $content;
