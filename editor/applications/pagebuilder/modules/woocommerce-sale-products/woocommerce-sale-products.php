<?php
/*
* Module Name: Woocommerce sale products
* Module URI: http://www.siteeditor.org/modules/woocommerce-sale-products
* Description: Woocommerce sale products Module For Site Editor Application
...
if( !is_pb_module_active( "woocommerce-archive" )  || !is_pb_module_active( "woocommerce-content-product" ) ){
    sed_admin_notice( __("<b>Woocommerce Sale Products module</b> needed to <b>woocommerce archive module</b> and <b>woocommerce content product module</b> <br /> please first install and activate its ") );
    return ;
}
                        
class PBWoocommerceSaleProductsShortcode extends PBShortcodeClass{
    ...
    function __construct() {
        parent::__construct( array(
                "name"        => "sed_sale_products",                               //*require
                "title"       => __("Woo sale products","site-editor"),                 //*require for toolbar
                "description" => __("Woocommerce sale products","site-editor"),
                "icon"        => "icon-woo",                               //*require for icon toolbar
                "module"      =>  "woocommerce-sale-products",         //*require
        ...
        $this->sed_woo_shortcode = new SedWoocommerceShortcode( "sale_products" , $this );
    ...
    function contextmenu( $context_menu ){
      $archive_menu = $context_menu->create_menu( "woo-sale-products" , __("Woo Sale Products","site-editor") , 'woo-sale-products' , 'class' , 'element' , '' , "sed_sale_products" , array(
...
new PBWoocommerceSaleProductsShortcode();
...
$sed_pb_app->register_module(array(
    ...
    "title"       => __("Woo sale products","site-editor"),
    "description" => __("Woocommerce sale products","site-editor"),
    "icon"        => "icon-woo",
    "type_icon"   => "font",
    "shortcode"         => "sed_sale_products",
    "transport"   => "ajax" ,
