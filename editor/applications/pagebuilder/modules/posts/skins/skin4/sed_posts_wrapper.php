        ...
        <div class="col-md-12">
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <header class="entry-header">
                    ...
                    <h3 class="title sed-title-posts <?php if( !$sed_data['single_post_title_show']  ) echo 'hide'; ?>" ><?php the_title();?></h3>
                    ...
                    <div class="entry-meta item-meta <?php if( !$sed_data['single_post_meta_show'] ) echo 'hide'; ?>">
                        ...
                        switch ( get_post_format( get_the_ID() ) ) {
                            case 'aside':
                                ...
                                $icon_format = "fa fa-file-text";
                            break;
                            case 'audio':
                                $name_format = __("Audio" , "site-editor");
                                $icon_format = "fa fa-volume-up";
                            break;
                            case 'chat':
                                $name_format = __("Chat" , "site-editor");
                                $icon_format = "fa fa-comments";
                            break;
                            case 'image':
                            ...
                            case 'status':
                                ...
                                $icon_format = "fa fa-comment";
                            break;
                            case 'video':
                                $name_format = __("Video" , "site-editor");
                                $icon_format = "fa fa-youtube-play";
                            break;
                            default:
                        ...
                        <div class="item post-format">
                            <i class="<?php echo $icon_format ?>"></i>
                            <span><?php echo $name_format?></span>
                        </div>
                ...
                <footer class="entry-footer item-meta <?php if( !$sed_data['single_post_meta_show'] ) echo 'hide'; ?>">
					...
					<div class="item post-tags <?php if( !$sed_data['single_post_tags_show'] ) echo 'hide'; ?>" >
						...
						<?php foreach ( $tags as $tag ): ?>
							<a class="post-tag" href="<?php echo get_tag_link($tag->term_id); ?>"><?php echo $tag->name ?></a>
						<?php endforeach;
                        endif;?>
					</div>
                    ...
                    <div class="item post-cats <?php if( !$sed_data['single_post_cat_show'] ) echo 'hide'; ?>" >
                        ...
                        ?>
							<a class="post-cat" href="<?php echo esc_url( $category_link ); ?>"><?php echo $cat->name ?></a>
						<?php
                            endforeach;
                          endif; ?>
					</div>
