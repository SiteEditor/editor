...
Class SiteeditorTypography{
    ...
    function set_google_fonts(){
        include SED_PLUGIN_DIR . DS . 'framework' . DS . 'framework' . DS . 'google_fonts.php';
        $this->google_fonts = $google_fonts;
    }


    function set_standard_fonts(){
        include SED_PLUGIN_DIR . DS . 'framework' . DS . 'framework' . DS . 'standard_fonts.php';
        $this->standard_fonts = $standard_fonts;
    }

    function set_custom_fonts(){
        $custom_font = $this->get_custom_font();

        if( $custom_font !== false )
            $this->custom_fonts[ $custom_font['name'] ] = $custom_font['title'];
    }
    ...
    function get_custom_font(){
        ...
        if( !empty( $sed_general_data['custom_font_title'] ) && !empty( $sed_general_data['custom_font_name'] ) &&
            ...
            return array( "name" => $sed_general_data['custom_font_name'] , "title" => $sed_general_data['custom_font_title'] );
        }else
            return false;
    }
